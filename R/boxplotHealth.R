...
save(dfLong, file = 'data/healthEntanglementWindowData.rdata')
# run the glm 
...
name <- '/Users/robs/Dropbox/Papers/KnowltonEtAl_Entanglement/images/BoxPlotHealthByEntglClass_NonReproAndReproAnimals.pdf'
# This is per Amy's request to include both categories side by side. Instead of breaking down the gear/no-gear for shading
