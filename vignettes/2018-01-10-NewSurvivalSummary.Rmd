...
## Survival Dataframe
Let's loop over animals and compile a data frame with rows for each entangled individual; since the time windows will change, I'll keep those in a list column.
