...
We'll then summarize the mean survival of all those animals for each of the months during the entanglement survival window. Finally to build up the distribution of differences we'll sample from two binomials and take the differences. Mathematically, 
