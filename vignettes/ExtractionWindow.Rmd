...
ggsave(plot = p, filename = 'extractionWindow.pdf',
       path = 'E:\\rob\\Documents\\research\\manuscripts\\KnowltonEtAl_Entanglement\\images\\', device = 'pdf', width = 9, height = 6, units = 'in')
ggsave(plot = p, filename = 'extractionWindow.png',
       path = 'E:\\rob\\Documents\\research\\manuscripts\\KnowltonEtAl_Entanglement\\images\\', device = 'png', dpi = 300, width = 9, height = 6, units = 'in', scale = 0.8)
```
