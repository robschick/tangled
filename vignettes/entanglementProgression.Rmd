...
load("E:/rob/Documents/research/projects/rightWhaleEntanglement/src/data/deathyr.rda")
load("E:/rob/Documents/research/projects/rightWhaleEntanglement/src/data/dcut.rda")
```
...
```{r}
fateEnt <- fate
fateEnt[fateEnt == 0] <- NA
tallyList <- lapply(split(fateEnt, col(fateEnt)), table)

tmat <- matrix(NA, nrow = 4, ncol(fateEnt))
