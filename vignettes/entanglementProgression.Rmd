...
With the raw data, we can now build up a data structure. We populate this with 4's under the assumption that all animals start unentangled. We may vary this to NA to deal with the proper alignment to when animals are not yet born
...
plot(unentangled$dateTime, unentangled$mean, type = 'l', ylim = c(0, 100), 
     xlim = c(as.Date('1980-01-01'), as.Date("2014-07-01")),
     xlab = 'Date',  ylab = "Estimated Health Score")
lines(unentangled$dateTime, unentangled$mean + unentangled$sd, lty = 2)
lines(unentangled$dateTime, unentangled$mean - unentangled$sd, lty = 2)
